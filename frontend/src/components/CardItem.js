...
import { EditDrinkItem } from './EditDrinkItem';
  ...
  return(
    ...
    <Card className="design">
      ...
      <Card.Body>
        ...
        {item.isDeleted && <Card.Text>Not Visible to Customers</Card.Text>}
        <div className="price">
          <div className="edit">
    ...
    {/* {openDrink && <EditDrinkItem item={item} close = {()=>handleDrinkClose} />}
    {openFood && <EditFoodItem item={item} close = {()=>handleFoodClose} />} */}
    </>
    )
}
