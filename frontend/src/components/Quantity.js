    ...
    return (
        <div className="search_reset">
            <Modal centered={true} show={show} onHide={handleClose}>
                ...
                <Modal.Body>{<Alert color="danger" variant={"danger"}>{Cart_Quantity.MAX_QUANTITIY_ERROR_MSG}</Alert>}</Modal.Body>
            </Modal>
            <Button onClick={ () => handleChange(Cart_Quantity.SUBTRACT)} disabled={quantity === 0} variant="danger">{Cart_Quantity.SUBTRACT}</Button>
