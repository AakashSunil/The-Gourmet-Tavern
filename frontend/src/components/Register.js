            ...
            <Form onSubmit = { handleSubmit }>
                ...
                <Form.Group className="mb-3">
                    ...
                    <Form.Control 
                        ...
                        isInvalid = {msgtype==="All"? email.length === 0 : msgtype === "Email"}/>
                    <Form.Control.Feedback type='invalid'>{ msg }</Form.Control.Feedback>
                </Form.Group>
                <Form.Group className="mb-3">
                    ...
                    <Form.Control 
                        ...
                        isInvalid = {msgtype === "All"? phone.length === 0 : msgtype === "Phone"}/>
                    <Form.Control.Feedback type='invalid'>{ msg }</Form.Control.Feedback>
                </Form.Group>
                <Form.Group className="mb-3">
                    ...
                    <Form.Control 
                        ...
                        isInvalid = {msgtype ==="All"? address.length === 0 : msgtype === "Address"}/>
                    <Form.Control.Feedback type='invalid'>{ msg }</Form.Control.Feedback>
                </Form.Group>
                <Form.Group className="mb-3">
                    ...
                    <Form.Control 
                        ...
                        isInvalid = {msgtype === "All"? password.length === 0 : msgtype === "Password"}/>
                    <Form.Control.Feedback type='invalid'>{ msg }</Form.Control.Feedback>
                </Form.Group>
                <Form.Group className="mb-3">
                    ...
                    <Form.Control 
                        ...
                        isInvalid = {msgtype === "All"? password_confirm.length === 0 : msgtype === "Confirm_Password"} />
                    <Form.Control.Feedback type='invalid'>{ msg }</Form.Control.Feedback>
                </Form.Group>
                <Modal centered={true} show={show} onHide={handleClose}>
                    ...
                    <Modal.Body>{<Alert color="danger" variant={"danger"}>{msg}</Alert>}</Modal.Body>
                </Modal>
